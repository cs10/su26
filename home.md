...
<!-- <div style="background-color: #fff3cd; border: 1px solid #ffc107; border-radius: 6px; padding: 12px 16px; margin-bottom: 1rem;">
  ⚠️ <strong>Note:</strong> This website is still under construction. Information may be incomplete or missing.
</div> -->
...
**Attendance:** [CS10 General Attendance Form](https://forms.gle/3aYk8f19RusaipxEA)
